...
app.get('/games/:id/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.status(200).json(ads.map(ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hoursStart: (0, convert_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hoursStart), hourEnd: (0, convert_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hourEnd) });
    }));
}));
